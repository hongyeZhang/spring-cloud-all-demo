package com.zhq.hystrix.demo.callapsing;
...
public class HystrixCommand4Collapser extends HystrixCollapser<List<String>, String, Integer> {
    ...
    protected void mapResponseToRequests(List<String> batchResponse,
                    Collection<CollapsedRequest<String, Integer>> requests) {
        int count = 0;
        System.out.println("mapResponseToRequests request size " + requests.size()
                        + ", and batchResponse size " + batchResponse.size());
    ...
    private static final class BatchCommand extends HystrixCommand<List<String>> {
        ...
        protected List<String> run() throws Exception {
            ...
            for (CollapsedRequest<String, Integer> request : requests) {
                //模拟一个response
                String response = "ValueForKey: " + request.getArgument() + " thread:" + Thread
