package com.zhq.hystrix.demo.cache;
...
/**
 * Hystrix 请求缓存 如何判断请求是否从缓存获取值? ---根据请求参数判断,如果参数相同,则返回值相同,可取缓存结果
 *
 * @author ZHQ
 */
...
public class HystrixCommand4Cache extends HystrixCommand<Boolean> {
    ...
    public static class UnitTest {
        ...
        public void testHystrixCommand4Cache() {
            ...
            HystrixCommand4Cache command2a = new HystrixCommand4Cache(2,
                            "HystrixCommand4RequestCacheTest");
            HystrixCommand4Cache command2b = new HystrixCommand4Cache(2,
                            "HystrixCommand4RequestCacheTest");
            ...
            // 开启一个新的请求
            HystrixRequestContext.initializeContext();
            HystrixCommand4Cache command3a = new HystrixCommand4Cache(2,
                            "HystrixCommand4RequestCacheTest");
            HystrixCommand4Cache command3b = new HystrixCommand4Cache(2,
                            "HystrixCommand4RequestCacheTest");
